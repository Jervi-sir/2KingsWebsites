...
mainBtns.forEach((btn) => {
  ...
  btn.addEventListener("mouseenter", (e) => {
    console.log("Sup Boiii, sounds u want to inpect the elements, abit of js. do you want !");
...
const aboutMeTextContent =
  "I am Jervi, creating bruh sites, with the a bruh user experience, dont expect good things, alright !";
